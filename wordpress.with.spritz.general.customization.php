        ...
        <div class="spritzoptions">
            ...
            <div class="spritzoptions_row speedoptions" style="<?php echo (get_option('spritz_speed_option')=='N')?'display: none':''; ?>">
                ...
                <div class="spritzoptions_field">
                    ...
                    <div class="nfos"><?php echo __('Select the speed options your site visitors will have access to (hold down the CTRL or COMMAND key for multiple selections).','WordPresswithSpritz'); ?></div>
